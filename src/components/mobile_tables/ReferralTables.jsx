...
const ReferralTables = ({ referral }) => {
  const navigate = useNavigate();
  const [active, setActive] = useState([]);
  //   const firstData = [
  //     {
  //       fullName: secondLevel?.data[0]?.fullname,
  //       userName: secondLevel?.data[0]?.username,
  //       referrals: secondLevel?.data[0]?.no_of_refs,
  //       status: secondLevel?.data[0]?.status,
  //     },
  //   ];
  return (
