          ...
          <div className="w-[15%] space-x-4 relative  flex items-center h-20">
            ...
            {profileMenu && (
              <motion.div
                initial={{ scale: 0 }}
                animate={{ scale: 1 }}
                className="w-full absolute top-[4.5rem] left-0 button-shadow py-1 shadow-lg rounded-lg h-[7.4rem] bg-white"
              >
